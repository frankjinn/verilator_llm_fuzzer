...
%type<cbool>	 classVirtualE constraintStaticE taggedSoftE vltInlineFront
...
%type<classp>	 classFront covergroup_declarationFront
...
%type<pinp>	 instParamItList instParamItListE instParamItem instParamListE instPinItListE instPinItemE instPinListE parameter_value_assignmentClass parameter_value_assignmentClassE parameter_value_assignmentInst parameter_value_assignmentInstE
...
%type<strp>	 bind_target_instance dpi_importLabelE endLabelE id idAny idAnyE idCC idInst idInstType idRandomize idSVKwd idType modportSimplePortOrTFPort netId package_import_itemObj str vltDBlock vltDContents vltDFTaskE vltDFile vltDHierDpi vltDMatch vltDModel vltDModule vltDModuleE vltDMtask vltDScope vltVarAttrVarE
